...
interface FilteredTasksListProps {
  category: 'total' | 'pending' | 'in-progress' | 'completed' | 'overdue';
}
...
export const FilteredTasksList: React.FC<FilteredTasksListProps> = ({ category }) => {
  ...
  const descMap = {
    ...
    overdue: 'Tasks that have passed their due dates without completion.',
  };
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="space-y-1">
          <Link href="/dashboard" className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground font-semibold mb-1 transition-colors">
