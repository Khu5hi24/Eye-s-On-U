          ...
          <div className="flex items-center justify-center gap-2">
            {otpValues.map((value, index) => (
              <input
                ...
                className="h-12 w-10 rounded-md border border-border bg-input text-center text-lg font-semibold text-foreground outline-hidden transition focus:border-ring focus:ring-1 focus:ring-ring"
              />
            ))}
          </div>
        </div>

        {message ? <p className="text-xs font-medium text-destructive mt-1 text-center">{message}</p> : null}
