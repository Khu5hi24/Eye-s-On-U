  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground transition-colors duration-300">
      ...
      <div className="flex flex-1 pt-16">
        ...
        <main
          className={cn(
            'flex-1 p-4 sm:p-6 md:p-8 transition-all duration-300 overflow-x-hidden min-h-[calc(100vh-4rem)] flex flex-col justify-between',
            sidebarCollapsed ? 'md:pl-20' : 'md:pl-56'
          )}
        >
          <div className="max-w-7xl mx-auto space-y-6 flex-1 w-full">{children}</div>
          <footer className="mt-6 border-t border-border/30 pt-3.5 text-[10px] text-muted-foreground/70 w-full">
