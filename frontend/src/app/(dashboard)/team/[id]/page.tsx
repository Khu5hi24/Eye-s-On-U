        ...
        <div className="space-y-6">
          <Card className="glass">
            <CardContent className="p-6 text-center space-y-4">
              <div className="relative w-24 h-24 mx-auto rounded-full overflow-hidden border-2 border-primary/10 shadow-md flex items-center justify-center bg-gradient-to-tr from-[#b89772]/20 to-[#c5a880]/30 text-accent font-bold text-2xl font-heading shadow-inner">
                {member.avatar ? (
