...
import { getProfile, getTeamMembers, updateProfile, updateUserById, updateAvatar, deleteAccount } from '../controllers/user.controller';
...
router.put('/member/:id', updateUserById);
