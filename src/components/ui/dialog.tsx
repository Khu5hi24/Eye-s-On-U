...
const DialogHeader = ({
  ...
  <div
    className={cn(
      'flex flex-col space-y-1.5 text-center sm:text-left border-b border-border/10 pb-4',
      className
    )}
    {...props}
  />
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      'flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2 border-t border-border/10 pt-4 mt-2',
      className
    )}
    {...props}
  />
