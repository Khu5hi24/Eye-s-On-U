      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        {[1, 2, 3].map((idx) => (
          <Card key={idx} className="h-80 animate-pulse-soft flex flex-col justify-between p-6">
            ...
            <div className="h-44 w-full rounded-lg bg-secondary/60" />
    ...
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
      <Card className="glass overflow-hidden">
        <CardHeader className="border-b border-border/50 bg-background/40">
          <CardTitle className="flex items-center justify-between text-sm font-semibold tracking-tight text-foreground">
            <span>Weekly Activity</span>
            <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-bold uppercase text-primary">Tasks Flow</span>
          </CardTitle>
        ...
        <CardContent className="h-64 p-4">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={weeklyData} margin={{ top: 5, right: 5, left: -25, bottom: 5 }}>
              ...
              <Tooltip contentStyle={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: '12px', boxShadow: '0 10px 30px -20px rgba(15, 23, 42, 0.45)' }} />
      ...
      <Card className="glass overflow-hidden">
        <CardHeader className="border-b border-border/50 bg-background/40">
          <CardTitle className="flex items-center justify-between text-sm font-semibold tracking-tight text-foreground">
            ...
            <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-bold uppercase text-primary">Status Mix</span>
          </CardTitle>
      ...
      <Card className="glass overflow-hidden">
        <CardHeader className="border-b border-border/50 bg-background/40">
          <CardTitle className="flex items-center justify-between text-sm font-semibold tracking-tight text-foreground">
            ...
            <span className="rounded-full bg-primary/10 px-2 py-0.5 text-[10px] font-bold uppercase text-primary">DB Rank</span>
          </CardTitle>
